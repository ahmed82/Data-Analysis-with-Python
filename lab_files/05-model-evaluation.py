# -*- coding: utf-8 -*-
"""
Created on Tue Mar 31 13:41:27 2020
...
#---------------------------------------------------------------------------------
"""What is the correct use of the "train_test_split" function such that 40% 
of the data samples will be utilized for testing, the parameter "random_state" 
is set to zero, and the input variables for the features and targets 
are_data, y_data respectively.

Answer:
     train_test_split(x_data, y_data, test_size=0.4, random_state=0) - correct
...
We will place the target data <b>price</b> in a separate dataframe <b>y</b>:"""
...
"""Use the function "train_test_split" to split up the data set such that 
40% of the data samples will be utilized for testing, set the parameter 
"random_state" equal to zero. The output of the function should be the 
...
# We can use negative squared error as a score by setting the parameter 'scoring' 
# metric to 'neg_mean_squared_error'.
-1 * cross_val_score(lre,x_data[['horsepower']], y_data,cv=4,scoring='neg_mean_squared_error')

"""Question #3): 
Calculate the average R^2 using two folds, find the average R^2 for the second fold 
utilizing the horsepower as a feature :"""
...
It turns out that the test data sometimes referred to as the out of sample data is a much better 
measure of how well your model performs in the real world. One reason for this is overfitting; 
let's go over some examples. It turns out these differences are more apparent in Multiple 
Linear Regression and Polynomial Regression so we will explore overfitting in that context.
...
RigeModel = Ridge(alpha=10) #  it was alpha=0
RigeModel.fit(x_train_pr, y_train)
